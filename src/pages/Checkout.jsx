...
const total = calculateTotal(carrito, opcionEnvio);
  ...
  return (
    ...
    <form ref={formulario} onSubmit={handleSubmit} className='checkout-Formulario '>
      ...
      <ComponenteFormulario label="Correo Electrónico"  placeholder="Email" name="email" value={formValues.email} onChange={handleChange} />
      ...
      <ComponenteFormulario label="Ciudad , Provincia" placeholder="Ciudad , Provincia" name="city" value={formValues.city}onChange={handleChange}/>
